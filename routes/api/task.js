...
// @desc    Get my tasks
// @access  Private
router.get('/my', passport.authenticate('jwt', { session: false }), async (req, res, next) => {
...
// @access  Private
router.get('/forme', passport.authenticate('jwt', { session: false }), async (req, res, next) => {
...
// @access  Private
router.put('/status/:id', passport.authenticate('jwt', { session: false }), async (req, res, next) => {
...
// @access  Private
router.put('/archived/:id', passport.authenticate('jwt', { session: false }), async (req, res, next) => {
...
// @desc    Update task archive status
// @access  Private
router.put('/delete/:id', passport.authenticate('jwt', { session: false }), async (req, res, next) => {
