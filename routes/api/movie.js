...
// @route   POST api/movie/tmdb
// @desc    Adds a new movie to database from tmdb
// @access  Private/Admin
router.post('/tmdb', passport.authenticate('jwt', { session: false }), roles.isAdmin, async (req, res, next) => {
  try {
    ...
    const response = await axios.get('https://api.themoviedb.org/3/movie/' + req.body.id + '?api_key=ca8f1fea6bfe2ee1300c1465e40444d9');
...
// @route   POST api/movie/masstmdb
// @desc    Adds new movies to database from tmdb
// @access  Private/Admin
// router.post(
//   '/masstmdb',
