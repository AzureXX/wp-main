...
// @route   GET api/user/getedustatus/:type/:id
// @desc    Return user by username or id
// @access  Private/User
...
// @desc    Calculate and return user tags
// @access  Private
router.get('/tags', passport.authenticate('jwt', { session: false }), async (req, res, next) => {
  await requests.calculateUserTags(req, res, next);
});

// @route   PUT api/user/update
// @desc    Changes user's general info
// @access  Private
...
// @access  Private
router.put('/changepass', passport.authenticate('jwt', { session: false }), async (req, res, next) => {
  try {
...
// @access  Private
router.put('/emote', passport.authenticate('jwt', { session: false }), async (req, res, next) => {
  try {
...
// @desc    Changes general access settings
// @access  Private
router.put('/generalaccess', passport.authenticate('jwt', { session: false }), async (req, res, next) => {
  try {
