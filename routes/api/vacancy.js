...
// @desc    Get all vacancies of current user
// @access  Private/Business
router.get('/get/current', passport.authenticate('jwt', { session: false }), roles.isBusiness, async (req, res, next) => {
  try {
...
// @access  Private/Business
router.post('/add', passport.authenticate('jwt', { session: false }), roles.isBusiness, async (req, res, next) => {
...
// @access  Private/Business
router.put('/edit/:id', passport.authenticate('jwt', { session: false }), roles.isBusiness, async (req, res, next) => {
...
// @access  Private/Business
router.delete('/delete/:id', passport.authenticate('jwt', { session: false }), roles.isBusiness, async (req, res, next) => {
